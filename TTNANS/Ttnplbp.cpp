...
mhintclear();
mhintf(true,"Plain Backpropagation ANS is an iterative algorithm with long training\n");
mhintf(true,"times. You are about to define the maximum number of iterations (z).\n");
mhintf(true,"However, on machines with small maximum integer sizes, z may not be \n");
mhintf(true,"large enough. To allow larger numbers of maximum iterations a second\n"); 
mhintf(true,"parameter (training phase) is used.\n");
mhintf(true,"The maximum number of iterations will be p*z, (where p = number of\n");
mhintf(true,"training phases, z = iterations per training phase).\n");
mhintf(true," \n");
...
if((Trainset!=NULL)&&
 ...
 if(RunAlgorithm)
  ...
  mhintclear();
  mhintf(true,"                                            1       \n");
  mhintf(true,"Node threshold function sigmoid (f(x) =  ________ ).\n");
  mhintf(true,"                                               -x   \n");
  mhintf(true,"                                          1 + e     \n");
  mhintf(true,"(f(x) in 0..1).\n");
