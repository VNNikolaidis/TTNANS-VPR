...
if(TGBL no_error)	/* if error has already occured don't add more allocs;*/
...
mprintf("A MemoryGuard error now indicates that some memory was not properly freed.\n");
mprintf("\n");
