...
while((*z<500)||(*z>10000))
 {
 mprintf("Please select parameter 'z' (max t) (500=<z=<10000).\n");
 *z=mrequest_int("Select z :");
 }

mprintf("Please select learning rate factor 'a'.\n");
mprintf("This is the maximum correction (occuring at t=1) that\n");
mprintf("can be applied on a cluster center using the distance\n");
mprintf("of this center to a given training set item.\n");
while((*a<0)||(*a>1))
 {
